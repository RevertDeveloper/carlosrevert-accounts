...
2. Arranca producción con `docker compose -f compose.yaml up -d --build`. El fichero `compose.dev.yaml` está reservado al desarrollo local y no se carga automáticamente.
